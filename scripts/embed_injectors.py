...
INJECTOR_CORE = os.path.join(REPO_ROOT, "js/injector-core.js")
INJECTOR_CONFIG = os.path.join(REPO_ROOT, "js/injector-config.js")
...
def main():
    ...
    if changed_files:
        for f in changed_files:
            if f == "js/injector-core.js" or f == "js/injector-config.js":
